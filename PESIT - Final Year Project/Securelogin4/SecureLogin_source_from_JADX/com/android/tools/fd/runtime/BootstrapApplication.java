...
public class BootstrapApplication extends Application {
    ...
    public BootstrapApplication() {
        Log.i(LOG_TAG, String.format("Instant Run Runtime started. Android package is %s, real application class is %s.", new Object[]{AppInfo.applicationId, AppInfo.applicationClass}));
    }
        ...
        if (file != null) {
            try {
                ...
                if (Log.isLoggable(LOG_TAG, 2)) {
                    ...
                    Log.v(LOG_TAG, "APK last modified: " + apkModified + " " + (apkModified > resourceModified ? ">" : "<") + " resource patch");
                }
