    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConnect.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                onetimekey = locpass();
                com.example.android.securelogin.Client myClient = new com.example.android.securelogin.Client(editTextAddress, editTextPort, response, account, number, passw.getText().toString(), onetimekey);
                myClient.execute();
                try {
                    TimeUnit.SECONDS.sleep(8);
                    openBankActivity(view);
